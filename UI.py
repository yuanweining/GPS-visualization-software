...
class GUI(QWidget):
    ...
    def initUI(self):
        self.radar_image = QtGui.QPixmap('img/radar3.png')
        self.gps_image = QtGui.QPixmap('img/gps.png')
        self.glonass_image = QtGui.QPixmap('img/glonass.png')
        ...
        self.lcd.display('2020-11-01 22:48:01')
        ...
        self.btn1.move(750,800)
        self.btn1.pressed.connect(self.timer1.start)
